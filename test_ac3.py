...
def test_cria_produto(atributo):
	try:
		...
		raise AssertionError('Erro ao criar Produto')
	else:
...
def test_cria_produtoFisico(atributo):
	try:
		...
		raise AssertionError('Erro ao criar ProdutoFisico')
	else:
...
def test_cria_produtoEletronico(atributo):
	try:
		...
		raise AssertionError('Erro ao criar um ProdutoEletronico')
	else:
...
def test_produtoEletronico_heranca():
	try:
		...
		raise AssertionError('Erro ao criar ProdutoEletronico')
...
def test_cria_ebook(atributo):
	try:
		...
		raise AssertionError('Erro ao criar um Ebook')
	else:
...
def test_ebook_heranca():
	try:
		...
		raise AssertionError('Erro ao criar Ebook')
